...
declare function Avatar({ fallback, ...rest }: AvatarProps): JSX.Element;
...
declare function Toast({ title, description, day }: ToastProps): JSX.Element;
...
declare const CalendarButton: _stitches_react_types_styled_component.StyledComponent<"button", {
    isAvaliable?: boolean | "true" | "false" | undefined;
}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        readonly white: "#FFF";
        readonly black: "#000";
...
interface CalendarButtonProps extends ComponentProps<typeof CalendarButton> {
}

interface DayCalendarProps extends CalendarButtonProps {
    date: Date;
    isAvaliable: boolean;
}
declare function DayCalendar({ date, isAvaliable }: DayCalendarProps): JSX.Element;

export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, CalendarButton, CalendarButtonProps, Checkbox, CheckboxProps, DayCalendar, DayCalendarProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, Toast, ToastProps };
